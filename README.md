...
- Intro:
 	...
 	> 通过这门课的名字就可以得知该课的火热程度，在AI火热的今天，deep learning当仁不让成为了相当热门的课程。这门课的老师Bhiksha在第一节课就放大招劝退，“this course is not for rookie”，并且声称如果能够拿到B以上就可以在工业界胜任DL的工作（然而感觉master连找都不可能找到DL的工作）。
